...
const validationSchema = Joi.object({
    ...
    additionalMembers : Joi.object({
        ...
        phoneNo : Joi.string().trim().min(10).max(13).required(),
        email : Joi.string().email().trim().min(16).max(50).required(),
    }),
    payment : Joi.object({
