...
export default function GoKartForm({setShowModal}){
    ...
    return(
                        <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                >
                                    <span className="text-white opacity-7 h-8 w-8 text-2xl bg-red-600 flex items-center justify-center  py-0 rounded-full">
                                    x
                                    </span>
                                </button>
                                </div>
                                <div className="relative p-6 flex-auto">
                                <form onSubmit={handleFormSubmit} className="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 w-full">
                                    ...
                                    <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" type="email"
                                    ...
                                    <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" 
                                        ...
                                        onChange={(e) => {
                                            setFormData({ ...formData, coCaptainPhoneNo: e.target.value });
                                        }}
                                    />
                                    <label className="block text-black text-sm font-bold mb-1">
                                    Co-Captain Email
                                    ...
                                    <div>
                                        {
                                            Object.entries(additional).map((val, key) =>{
                                                return(
                                                    <div key={key} >
                                                        {
                                                            (key === 0) ? <> <br/> < div className='text-black' >Additional Members Are&nbsp;: </div></> :  <></>
                                                        }
                                    ...
                                    <span>
                                        <button className='w-16 h-8 my-4  text-black border-yellow-800 border-2 bg-yellow-200' onClick={addField} >
                                            +
                                        </button> &nbsp;&nbsp;
                                        <button className='w-16 h-8 my-4  text-black border-yellow-800 border-2 bg-yellow-200' onClick={removeLastField} >
                                            -
                                        </button>
                                    </span>
                                    <div>
