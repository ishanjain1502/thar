...
export default function Hero() {
  return (
    <>
      ...
      <div className="min-h-screen bg-black/5 backdrop-blur-3xl flex flex-col justify-center items-center text-center">
        <div className="w-10/12 mx-auto flex flex-col justify-center items-center text-center">
          {" "}
          <div className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold">
            <span className="text-yellow-300">Thar</span> RC NITRO Championship!
          </div>
          <div className="flex gap-8 items-center text-lg font-semibold md:self-start w-fit mx-auto">
            <div className="h-24 w-24 md:h-32 md:w-32 bg-white rounded-lg bg-opacity-20 backdrop-blur-3xl flex justify-center items-center flex-col mt-12">
              <p className="text-5xl">24</p>
              <p className="text-lg">Feb</p>
            </div>
            to
          ...
          <div className="flex flex-row flex-wrap gap-2 lg:gap-4 mt-12 text-xl lg:text-2xl xl:text-3xl">
            <a
              href="https://drive.google.com/file/d/1D5SFx9wd5FYXDPXNSJJsse-TIQrVizd2/view?usp=sharing"
              className="rounded-md ring-2 ring-yellow-300 bg-yellow-300 text-black font-semibold px-4 py-2 self-start"
            >
