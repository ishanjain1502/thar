  ...
  return (
    <footer className="w-full mx-auto p-4 sm:p-6 mt-10">
      ...
      <span className="a flex flex-col justify-center text-xs text-zinc-300 self-end text-center">
        ...
        <br />
        Akelgarh, Rawatbhata Road - 324010
        <span>
          Mail us -{" "}
          <a
      ...
      <div className="flex flex-row flex-wrap gap-4 justify-center my-2">
        ...
        {/* Youtube */}
        <a
          href="https://www.youtube.com/@rtuthar2023"
          className="text-zinc-400 hover:text-zinc-200 transition-all ease-out"
          target="_blank"
          rel="noreferrer noopener"
        >
...
export const FACEBOOK_SVG = ({ size }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const INSTAGRAM_SVG = ({ size }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
export const YOUTUBE_SVG = ({ size }) => {
  return (
    <svg
      ...
      viewBox="0 0 30 30"
    >
      <path d="M15 4c-4.186 0-9.62 1.049-9.62 1.049l-.013.015A3.99 3.99 0 002 9v12.002a4 4 0 003.377 3.943l.004.006s5.433 1.051 9.619 1.051 9.62-1.05 9.62-1.05l.001-.003A4 4 0 0028 21.002V9a4 4 0 00-3.377-3.945l-.004-.006S19.186 4 15 4zm-3 6.398L20 15l-8 4.602v-9.204z"></path>
    </svg>
  );
};
